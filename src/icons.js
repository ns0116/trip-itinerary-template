// Icon inventory: name -> inner SVG markup (extracted from Lucide, ISC license,
// https://lucide.dev). Rendered inside a shared <svg> wrapper by iconSvg() so
// color always follows `currentColor` and themes never need per-icon assets.
export const ICONS = {
...
// type -> iconName. Design sets may override individual entries via their own
// `icons` object; anything they don't override falls back to this table.
...
// type -> semantic tint bucket. Buckets resolve to CSS variables in styles.css
// (color-mix over --c-primary/accent/support/text-muted) so icon backgrounds
// stay theme-driven instead of hardcoding a color per type.
