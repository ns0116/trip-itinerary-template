...
All demo data is **entirely fictional**. Place names, hotel names, and shop
names are invented homages, not real locations — any resemblance to real
businesses is coincidental.

- [Coastal — weatherModes + candidates (fictional island trip)](https://ns0116.github.io/trip-itinerary-template/examples/okinawa/)
- [Iberia — checklist (fictional two-city trip)](https://ns0116.github.io/trip-itinerary-template/examples/spain/)
- [Noir — bare-minimum feature set (fictional business trip)](https://ns0116.github.io/trip-itinerary-template/examples/novaport/)
- [Washi — checklist + candidates (fictional hot-spring trip)](https://ns0116.github.io/trip-itinerary-template/examples/yumori/)
...
- **4 Design Sets** — swap the whole look with one line (`config.design`):
  ...
  All four have a full demo itinerary in `examples/`, and `docs/DESIGN_SETS.md`
  has the token reference.
...
examples/               four full demo itineraries (all fictional data)
...
— the Design Set decides the icon and color, not the data. See each form in
the examples:

- `examples/okinawa/config.js` — the weatherModes + candidates form
- `examples/spain/config.js` — the checklist form
- `examples/novaport/config.js` — every feature flag off, minimal form
- `examples/yumori/config.js` — checklist + candidates combined
