...
export default {
  ...
  darkColors: { /* 任意: OS ダークモード時に上書きする色トークン（同キー構造） */ },
...
実データ由来の確定値。
```
light: --c-base:#f9f9f9  --c-surface:#ffffff  --c-primary:#8b0000(sangria)
       --c-accent:#C85A32(terracotta)  --c-support:#556B2F(olive)
       --c-text:#2d2d2d  --c-text-muted:#7a7a7a  --c-border:#ececec
dark:  --c-base:#1c1917  --c-surface:#27211e  --c-primary:#c47a7a
       --c-accent:#c87f5a  --c-support:#7aad5e
       --c-text:#ede5dc  --c-text-muted:#9a9088  --c-border:#3d3128
...
実データ由来の確定値。
```
light: --c-base:#EBF5FA  --c-surface:#ffffff  --c-primary:#003A5C(ocean-deep)
       --c-accent:#E8562A(coral)  --c-support:#00897B(teal)
       --c-text:#1A2E3A  --c-text-muted:#5A7080  --c-border:#e0f2fe(sky-100)
dark:  --c-base:#0e1d2b  --c-surface:#152335  --c-primary:#4db8e0
       --c-accent:#e8683f  --c-support:#28a89a
       --c-text:#cce8f5  --c-text-muted:#6895ab  --c-border:#1e3a52
...
起点値（実装時に微調整可）。
```
light: --c-base:#f4f4f5  --c-surface:#ffffff  --c-primary:#18181b
       --c-accent:#3f3f46  --c-support:#71717a
       --c-text:#18181b  --c-text-muted:#71717a  --c-border:#e4e4e7
dark:  --c-base:#0e0e10  --c-surface:#18181b  --c-primary:#e4e4e7
       --c-accent:#a1a1aa  --c-support:#71717a
       --c-text:#e4e4e7  --c-text-muted:#71717a  --c-border:#27272a
...
起点値（実装時に微調整可）。
```
light: --c-base:#f5f1e8  --c-surface:#fffdf8  --c-primary:#5b4636(墨/土)
       --c-accent:#9c6b3f(枯茶)  --c-support:#6a7f4f(苔)
       --c-text:#3a352e  --c-text-muted:#8a8072  --c-border:#e6ddca
dark:  --c-base:#1a1814  --c-surface:#221e18  --c-primary:#c4a07a
       --c-accent:#c48050  --c-support:#7aaa5e
       --c-text:#e8e0d4  --c-text-muted:#9a907e  --c-border:#362e22
